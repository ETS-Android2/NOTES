...
public class DisplayNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                userNameTextView.setText(String.format("Hello, %s", name));
            }
    ...
    public void addRecord(String title, String description) {
        ...
        DatabaseReference myRef = FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getUid());
    ...
    public void deleteAllRecords() {
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("Yes", (dialogInterface, i) -> {
                    FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getUid()).child("Notes").removeValue();
                    fetchAllRecords();
                })
